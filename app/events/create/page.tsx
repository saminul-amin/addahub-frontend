...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select"; // You might need to add Select component
...
export default function CreateEventPage() {
    ...
    useEffect(() => {
        ...
        try {
            ...
            if (decoded.role !== 'host' && decoded.role !== 'admin') {
                toast.error("Unauthorized", { description: "Only hosts can create events." });
    ...
    const onSubmit = async (data: any) => {
        try {
            ...
            if (res.data.success) {
                toast.success("Event Created!", { description: "Your event is now live." });
                router.push('/dashboard');
            }
        } catch (error: any) {
            console.error(error);
            toast.error("Creation Failed", { description: error.response?.data?.message || "Could not create event." });
        }
    };
        ...
        <div className="container mx-auto px-4 py-12 max-w-3xl">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Fill in the details to organize your next activity.</CardDescription>
                </CardHeader>
                <CardContent>
                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Input id="title" placeholder="e.g. Sunday Morning Hike" {...register('title', { required: true })} />
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea id="description" placeholder="Describe what you'll be doing..." {...register('description', { required: true })} />
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input id="location" className="pl-10" placeholder="Address or Place Name" {...register('location', { required: true })} />
                                </div>
