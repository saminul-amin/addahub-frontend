        ...
        <div className="container px-4 md:px-6 mx-auto">
          ...
          >
            <motion.div variants={itemVariants}>
                <Badge variant="secondary" className="px-4 py-2 text-sm bg-indigo-50 text-indigo-700 hover:bg-indigo-100 rounded-full border border-indigo-100">
                   ✨ The new way to connect locally
                </Badge>
            </motion.div>
        ...
        <section className="py-20 bg-white">
            <div className="container px-4 md:px-6 mx-auto">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                     {/* Dummy Cards - Ideally dynamic */}
                     {[1, 2, 3].map((i) => (
                         <div key={i} className="group rounded-2xl overflow-hidden border border-gray-100 bg-white shadow-sm hover:shadow-xl transition-all duration-300">
                             ...
                             <div className="p-6">
                                 <div className="text-sm text-indigo-600 font-medium mb-2">Weekend • 10:00 AM</div>
                                 <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-indigo-600 transition-colors">Group Hike & Picnic #{i}</h3>
                                 <p className="text-gray-500 text-sm mb-4 line-clamp-2">Enjoy nature with specific people who love outdoors.</p>
                                 <div className="flex items-center text-sm text-gray-500">
                                     <MapPin className="h-4 w-4 mr-1" /> Central Park
                                 </div>
                             </div>
                         </div>
                     ))}
